...
$routes->group('', ['filter' => 'auth'], function ($routes) {
  ...
  $routes->get('audit/pelaksanaan-audit/edit/(:num)', [PelaksanaanAudit::class, 'edit/$1']);
  $routes->get('audit/pelaksanaan-audit/getPernyataanByStandar/(:num)', [PelaksanaanAudit::class, 'getPernyataanByStandar/$1']);
  $routes->get('audit/pelaksanaan-audit/getDetailPernyataan/(:num)', [PelaksanaanAudit::class, 'getDetailPernyataan/$1']);
  $routes->post('audit/pelaksanaan-audit/simpan', [PelaksanaanAudit::class, ' simpan']);
  ...
  $routes->match(['GET', 'POST'], 'akreditasi/unit/input', [Unit::class, 'input']);
  ...
  $routes->get('akreditasi/input-data-pemutu/get-lembaga/(:num)', [InputDataPemutu::class, 'getLembaga/$1']);
});
