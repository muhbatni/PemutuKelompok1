      ...
      <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
        <div class="row align-items-center">
          <div class="col-xl-4 order-1 order-xl-1 m--align-left">
            <a href="/pemutu/public/akreditasi/unit/input" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
              <span>
            ...
            <?php if (!empty($unit)) : ?>
              <?php $no = 1; foreach ($unit as $row) : ?>
                <tr>
                  ...
                  <td>
                  <a href="<?= site_url('akreditasi/unit/input?id=' . $row['id']) ?>" class="btn btn-sm btn-warning">Edit</a>
